...
const contractFormSchema = z
  .object({
    ...
    contract_value: z.coerce
      ...
      .optional()
      .nullable(),
    job_title: z.string().max(100, "Job title is too long").optional().nullable(),
    work_location: z.string().max(200, "Work location is too long").optional().nullable(),
  })
  .refine(
    (data) => {
...
const InputWithIcon = React.memo(
  ({
    ...
    <div className="relative">
      <Icon
        className={`pointer-events-none absolute left-3 top-3 h-4 w-4 transition-colors ${
...
export function ContractGeneratorForm({
  ...
  if (isLoading) {
    return (
      <Card className={`mx-auto max-w-4xl ${className || ""}`}>
        <CardHeader>
  ...
  return (
    <Card className={`mx-auto max-w-4xl shadow-lg ${className || ""}`}>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormDescription>Typically the client or service recipient</FormDescription>
                      <FormControl>
                        <ComboboxField
                          field={field}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormDescription>Typically the employer or service provider</FormDescription>
                      <FormControl>
                        <ComboboxField
                          field={field}
                          options={partyOptions}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormDescription>Total monetary value (optional)</FormDescription>
                      <FormControl>
                        <InputWithIcon
                          icon={DollarSign}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormDescription>Position or role description (optional)</FormDescription>
                      <FormControl>
                        <InputWithIcon icon={Briefcase} error={!!form.formState.errors.job_title}>
                          <Input
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>Primary work location or address (optional)</FormDescription>
                    <FormControl>
                      <InputWithIcon icon={MapPin} error={!!form.formState.errors.work_location}>
                        <Input
