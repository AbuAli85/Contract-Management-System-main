      ...
      <div className="flex flex-col space-y-4 lg:flex-row lg:items-center lg:justify-between lg:space-y-0">
        <div>
          ...
          <p className="text-muted-foreground">
            Manage and track all your contracts with real-time status updates and comprehensive
            analytics.
          </p>
        </div>
                    ...
                    <TableRow key={contract.id}>
                      ...
                      <TableCell>
                        <div className="space-y-1">
                          ...
                          {contract.email && (
                            <div className="text-xs text-muted-foreground">{contract.email}</div>
                          )}
                        </div>
                      </TableCell>
                      <TableCell>
                        <div className="space-y-1">
                          <div className="text-sm font-medium">{contract.job_title || "N/A"}</div>
                          ...
                          <DropdownMenuContent align="end">
                            ...
                            {contract.pdf_url ? (
                              ...
                              >
                                ...
                                {isGenerating === contract.contract_number
                                  ? "Generating..."
                                  : "Generate PDF"}
                              </DropdownMenuItem>
                            )}
                              ...
                              <AlertDialogContent>
                                <AlertDialogHeader>
                                  ...
                                  <AlertDialogDescription>
                                    ...
                                    {contract.contract_number}? This action will hide it from the
                                    main view but keep it in the database.
                                  </AlertDialogDescription>
                                </AlertDialogHeader>
                                <AlertDialogFooter>
        ...
        <Dialog open={!!selectedContract} onOpenChange={() => setSelectedContract(null)}>
          <DialogContent className="max-h-[80vh] max-w-4xl overflow-y-auto">
            <DialogHeader>
              ...
              <DialogDescription>Complete contract information and timeline</DialogDescription>
            </DialogHeader>
              ...
              <TabsContent value="general" className="space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <p className="font-mono text-sm">{selectedContract.contract_number}</p>
                  </div>
                  <div>
                    ...
                    <CardContent className="space-y-2">
                      <div>
                        ...
                        <p className="text-sm font-medium">
                          {selectedContract.first_party_name_en || "N/A"}
                        </p>
                      </div>
                      <div>
                  ...
                  <Card>
                    ...
                    <CardContent className="space-y-2">
                      <div>
                        <Label className="text-xs">English Name</Label>
                        <p className="text-sm font-medium">
                          {selectedContract.second_party_name_en || "N/A"}
                        </p>
                      </div>
                      <div>
                        <Label className="text-xs">Arabic Name</Label>
                  ...
                  <Card>
                    ...
                    <CardContent className="space-y-2">
                      <div>
                        <Label className="text-xs">English Name</Label>
                        <p className="text-sm font-medium">
                          {selectedContract.promoter_name_en || "N/A"}
                        </p>
                      </div>
                      <div>
                        <Label className="text-xs">Arabic Name</Label>
                    ...
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <Button
                          ...
                          onClick={() => window.open(selectedContract.pdf_url, "_blank")}
                        >
