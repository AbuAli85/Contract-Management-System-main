...
export const contractFormSchema = z
  .object({
    first_party_id: z.string().min(1, "First party is required").uuid("Invalid party selection"),

    second_party_id: z.string().min(1, "Second party is required").uuid("Invalid party selection"),

    promoter_id: z.string().min(1, "Promoter is required").uuid("Invalid promoter selection"),
    ...
    work_location: z.string().max(200, "Work location is too long").optional(),
  })
