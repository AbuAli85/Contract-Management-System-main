...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    if (error) {
      ...
      return NextResponse.json({ error: 'Failed to create role: ' + error.message }, { status: 400 })
    }
...
export async function PUT(request: NextRequest) {
  ...
  try {
    ...
    if (error) {
      ...
      return NextResponse.json({ error: 'Failed to update role: ' + error.message }, { status: 400 })
    }
...
export async function DELETE(request: NextRequest) {
  ...
  try {
    ...
    if (error) {
      ...
      return NextResponse.json({ error: 'Failed to delete role: ' + error.message }, { status: 400 })
    }
