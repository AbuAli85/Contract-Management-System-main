...
export async function setUserActiveStatus(userId: string, isActive: boolean, adminId: string) {
  // Update user status
...
export async function resetUserPassword(userId: string, newPassword: string, adminId: string) {
