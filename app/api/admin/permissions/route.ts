...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    const permissions = dbPermissions && dbPermissions.length > 0 ? dbPermissions : predefinedPermissions
...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    if (error) {
      ...
      return NextResponse.json({ error: 'Failed to create permission: ' + error.message }, { status: 400 })
    }
...
export async function PUT(request: NextRequest) {
  ...
  try {
    ...
    if (error) {
      ...
      return NextResponse.json({ error: 'Failed to update permission: ' + error.message }, { status: 400 })
    }
...
export async function DELETE(request: NextRequest) {
  ...
  try {
    ...
    if (error) {
      ...
      return NextResponse.json({ error: 'Failed to delete permission: ' + error.message }, { status: 400 })
    }
