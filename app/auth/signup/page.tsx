...
import { Loader2, Mail, Lock, User, AlertCircle, Check, X, Shield, ArrowRight } from "lucide-react"
        ...
        <CardContent className="space-y-4">
          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
            ...
            <div className="flex items-start space-x-2">
              <Checkbox id="acceptTerms" {...form.register("acceptTerms")} disabled={isLoading} />
