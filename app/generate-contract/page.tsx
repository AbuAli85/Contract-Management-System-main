      ...
      <div className="space-y-4">
        ...
        <div className="grid gap-4 md:grid-cols-4">
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold text-green-600">{contractStats.thisMonth}</div>
              <p className="mt-1 text-xs text-muted-foreground">New contracts</p>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              ...
              <p className="mt-1 text-xs text-muted-foreground">Time to complete</p>
            </CardContent>
          </Card>
        ...
        <TabsContent value="templates" className="space-y-6">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Choose how you want to create your contract</CardDescription>
            </CardHeader>
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              ...
              <Badge variant="secondary">{contractTemplates.length} templates available</Badge>
            </div>
          ...
          <Card>
            ...
            <CardContent className="space-y-6">
              ...
              <Alert>
                ...
                <AlertDescription>
                  <strong>Pro Tip:</strong> Make sure all parties and promoters are registered in
                  the system before creating a contract. You can add them from the Manage Parties
                  and Manage Promoters sections.
                </AlertDescription>
              </Alert>
